...
| ---------------------------- | --------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------- |
| `settingsModel` _(required)_ | --        | Model settings for new scan | `{ id: number; intensity: IntensityType; path: string[]; checkMask: string[]; excludeMask: string[]; docroot: string; }` | `undefined` |
