...
export const StartCheckIcon: FunctionalComponent<StartCheckIconProps> = props => {
  ...
  const textColor = props.disabled ? '#9b9b9b' : '#0279C0';
  return (
    <svg
      onClick={!props.disabled && props.onClick.bind(this)}
      width="140"
      height="30"
      viewBox="0 0 140 30"
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill={color}
      />
      <path d="M29.6102 16.2782L31.9416 14.3902L33.3625 17.1" stroke={textColor} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18.9267 12.685L16.6286 14.6133L15.1607 11.9288" stroke={textColor} strokeLinecap="round" strokeLinejoin="round" />
      <rect x="0.5" y="0.5" width="139" height="29" rx="2.5" stroke={color} />
    </svg>
  );
};
