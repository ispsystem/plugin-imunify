/**
 * Typing for object deep paths
 *
 * code from https://github.com/microsoft/TypeScript/issues/12290#issuecomment-449425101
 */
...
type ArrayHasIndex<MinLength extends number> = { [K in MinLength]: any };

export type PathArrayValue<T, L extends PathArray<T, L>> = L extends ArrayHasIndex<0 | 1 | 2 | 3 | 4 | 5 | 6 | 7>
  ? any
...
export type PathValue<T, L extends Path<T, L>> = L extends PathArray<T, L> ? PathArrayValue<T, L> : L extends keyof T ? T[L] : any;
