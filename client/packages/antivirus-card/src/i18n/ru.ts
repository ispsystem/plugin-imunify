const lang = {
  ...
  INFECTED_FILES: {
    NOT_FOUND:
      'Сейчас всё хорошо, заражённых файлов нет. В случае появления вирусов, информация о них будет храниться в этой вкладке. Для лечения вирусов вам понадобится ImunifyAV+. Оформить подписку можно сейчас.',
    ...
    SUBSCRIBE_TO_PRO: 'Оформить подписку на ImunifyAV+',
    TABLE_HEADER: {
      CELL_1: 'Имя файла',
    ...
    MODAL: {
      ...
      GROUP_TITLE: 'Удалить %{smart_count} файл |||| Удалить %{smart_count} файла |||| Удалить %{smart_count} файлов',
